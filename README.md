...
Εκπαιδευτές/Καταρτιζόμενοι: http://localhost:5411 ή πχ apousies.saek_example.gr

Γραμματεία/Admin: http://localhost:5411 ή πχ grammateia.saek_example.gr
...
Ως admin, μπορείτε να εισάγετε αρχείο csv με τα δεδομένα της σχολής.
